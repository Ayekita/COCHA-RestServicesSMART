...
public class SmartDao {
	...
	public Bmcli getCliente(String nemote, Connection conJdbc)throws SQLException, ClassNotFoundException {
	...
	public Fmsct existeFmsct(int rutCli, Connection con) throws Exception {
		PreparedStatement ps = null;
		ResultSet rs = null;
		Fmsct fmsct = null;
		try {
	...
	public boolean ingresoSobregiro(Vmlcd datos, Connection con) throws SQLException, ClassNotFoundException {
		...
		try {
			...
			if(datos.getMonval().equalsIgnoreCase("CLP")) {
				ps.setLong(14,datos.getVallca());
				ps.setLong(15,datos.getVallcd());
			}
			else if(datos.getMonval().equalsIgnoreCase("USD")) {
	...
	public boolean insertVmpel(Vmpel vmpel, Connection conJdbc)throws SQLException, ClassNotFoundException {
		PreparedStatement ps = null;
		StringBuilder insert = new StringBuilder();
		boolean isOk = false;
		try {	
	...
	public boolean insertFmsct(Fmsct fmsctTo, Connection conJdbc)throws SQLException, ClassNotFoundException {
		PreparedStatement ps = null;
		StringBuilder insert = new StringBuilder();
		boolean isOk = false;
		try {	
	...
	public boolean updateFmcst(Fmsct fmsct ,Connection conJdbc)throws SQLException, ClassNotFoundException {
		PreparedStatement ps = null;
		boolean isOk = false;
		String query = "";
		try {			
